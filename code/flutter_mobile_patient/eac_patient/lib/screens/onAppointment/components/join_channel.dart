...
class State extends ConsumerState<JoinChannelVideo> {
  ...
  Future<void> _initEngine() async {
    ...
    var url = Uri.parse('https://asia-southeast1-asthma-care.cloudfunctions.net/generateAgoraToken?channelName=${ref.read(roomProvider)?.id??''}&userId=1'); // Replace with the actual URL
