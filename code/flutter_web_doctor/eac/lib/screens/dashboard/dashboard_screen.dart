                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: defaultPadding,),
TextButton(onPressed: (){
  ref.read(selectedPage.notifier).state="Patients";
...
class ListOngoing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('schedule').where("doctor",isEqualTo: uid).where("status", isEqualTo: "ongoing").limit(2).snapshots(),
...
class ListPatient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DataSnapshot>(
      future: FirebaseDatabase.instance.ref().child("myptnc").child(FirebaseAuth.instance.currentUser?.uid??'').limitToFirst(2).get(),
